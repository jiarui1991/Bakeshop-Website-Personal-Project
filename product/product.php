<?php
    ...
    $image_filename = $product_code . '_s.jpg';
    $image_path = 'images/' . $image_filename;
    $image_alt = 'Image filename: ' . $image_filename;
?>
<!-- display the product information in right side-->
<h1><?php echo $product_name; ?></h1>
<div id="left_column">
    <p><img src="<?php echo $image_path; ?>" width="360px" height="250px"
...
<div id="right_column">
    ...
    <form action="<?php echo  'cartindex.php' ?>" method="post">
